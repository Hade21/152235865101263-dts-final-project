...
const CardBook = ({
  ...
  return (
    <div className="card snap-start h-full flex flex-col lg:flex-row gap-2 lg:gap-4 items-center px-6 py-4 bg-slate-200 rounded-lg">
      ...
      />
      <div className="detail w-full font-rubik text-left flex flex-col justify-between h-full">
        <div className="desc">
          <h3
            className="font-bold text-base md:text-xl lg:text-2xl cursor-pointer"
            onClick={() => navigate(`/book/${id}`)}
          >
            {title}
          </h3>
