...
const Button = ({ children, type, model = "container" }) => {
  ...
  const outlined =
    "px-8 py-2 border-2 border-prime-blue rounded-sm shadow-md font-rubik text-prime-blue text-lg w-fit transition-all duration-200 hover:bg-fifth-pink hover:text-white active:translate-y-1 active:shadow-none";
  return (
    <>
      <button
        type={type}
